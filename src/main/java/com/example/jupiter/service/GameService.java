...
public class GameService {
    private static final String TOKEN = "Bearer 7pdjutve9lylgx8e5khumh0pd28luz";
    private static final String CLIENT_ID = "9f0thc4den9q7kp9euetr1f8k7djki";
...
// use hash map to store items by itemType
